...
class MixedIterablePyObjTest {
    ...
    void testToStringTup() {
        ...
        String[] tup1Options = new String[]{"({1, 2, 4}, set(), {3})",
            ...
            "({4, 2, 1}, set(), {3})"};
        assertTrue(List.of(tup1Options).contains(tupOfSets1.toString()));
    }
    ...
    void testToStringSet() {
        ...
        assertTrue(List.of(set1Options).contains(setOfTups1.toString()));
    }
    ...
    void testToStringDict() {
        ...
        String[] dict1Options = new String[]{
            ...
            "{(0.0,): [0, 0], (4.1, 4.5, 4.8, 5.1, 5.4): [17, 20, 23, 26, 29], (1.0, 2"
                + ".0, 3.0, 4.0): [2, 3, 4]}"};
        assertTrue(List.of(dict1Options).contains(dictOfTupsToLists1.toString()));
    }
    ...
    private static void setUpListsOfTuples() {
        ...
        List<PyTupleObj<PyStringObj>> listOfTupsVal =
            List.of(listSubtup1, listSubtup2, listSubtup3);
        listOfTups1 = new PyListObj<>(listOfTupsVal);

        // Do the exact same thing again to get two deeply unique objects
        listSubval1 = List.of(new PyStringObj("a"), new PyStringObj("b"));
        listSubtup1 = new PyTupleObj<>(listSubval1);
        listSubval2 = List.of(new PyStringObj("c"), new PyStringObj("d"));
        listSubtup2 = new PyTupleObj<>(listSubval2);
        listSubval3 = List.of(new PyStringObj("e"), new PyStringObj("f"));
        listSubtup3 = new PyTupleObj<>(listSubval3);

        listOfTupsVal = List.of(listSubtup1, listSubtup2, listSubtup3);
    ...
    private static void setUpTupsOfSets() {
        ...
        List<PySetObj<PyIntObj>> tupOfSetsVal =
            List.of(tupSubset1, tupSubset2, tupSubset3);
        ...
        tupOfSets2 = new PyTupleObj<>(List.of(tupSubset1, tupSubset2, tupSubset3));
    }
    ...
    private static void setUpSetsOfTuples() {
        ...
        List<PyTupleObj<PyBoolObj>> setOfTupsVal =
            List.of(new PyTupleObj<>(setSubval1), new PyTupleObj<>(setSubval2));
    ...
    private static void setUpDictsOfTuplesToLists() {
        ...
        List<PyIntObj> dictVal3 = List.of(new PyIntObj(0), new PyIntObj(0));
        ...
        dictVal3 = List.of(new PyIntObj(0), new PyIntObj(0));
    ...
    private static void setUpDeeplyNested() {
        ...
        List<PyBoolObj> key1 = List.of(new PyBoolObj(true), new PyBoolObj(false));

        // Make the val for the inner dictionary
        List<PyFloatObj> val1thirdLayer =
            List.of(new PyFloatObj(17.65), new PyFloatObj(-9.1));
        ...
        // Do the exact same thing again to get two deeply unique objects
        key1 = List.of(new PyBoolObj(true), new PyBoolObj(false));
        val1thirdLayer = List.of(new PyFloatObj(17.65), new PyFloatObj(-9.1));
